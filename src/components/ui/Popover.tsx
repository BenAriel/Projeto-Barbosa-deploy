...
function Trigger({ children }: { children: React.ReactElement }) {
    ...
    const childrenToTriggerPopover = React.cloneElement(children, {
        onMouseEnter, // Replaced onClick with onMouseEnter
        onMouseLeave, // Added onMouseLeave
...
function useFocusTrapping() {
    ...
    const onKeyDown = useCallback((e: KeyboardEvent) => {
        ...
        const focusables = Array.from(popover.querySelectorAll(focusableQuery));
...
function mergeRef(...refs: Array<((instance: HTMLElement | null) => void) | React.RefObject<HTMLElement>>) {
